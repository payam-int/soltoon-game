...
import shared.communication.command.InvalidCommandException;
import shared.communication.query.Query;
import shared.communication.query.QueryAction;
import shared.communication.query.QueryFinalize;
import shared.communication.result.ResultAction;
import shared.communication.result.ResultInitialize;
import shared.communication.result.Status;
import shared.data.action.*;
